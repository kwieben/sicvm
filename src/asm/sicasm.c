...
void pass2(void)
{
	...
	char strBuffer[30] = ""; //REG_A temporary string buffer
	char strByteOrWordOperand[30] = ""; //REG_A string buffer that stores the Operand for Byte or Word, it is used 
...
void parseArguments(int argc, char* argv[])
{
	...
	while ((cArgument = getopt(argc, argv, "o:bld:O::vVh")) != -1) {
		...
		case 'v': //Displays the Version number
			printf("sicasm: REG_A Simple SIC Assembler v1.2-0\n\n");
			exit(EXIT_SUCCESS);
			//break;
